...
class Runner(lnprototest.Runner):
    ...
    def __reserve(self) -> int:
        ...
        anymore when we go to bind the daemon like brocoind port.
    ...
    def start(self, also_brocoind: bool = True) -> None:
    ...
    def shutdown(self, also_brocoind: bool = True) -> None:
    ...
    def stop(self, print_logs: bool = False, also_brocoind: bool = True) -> None:
        self.logger.debug("[STOP]")
        self.shutdown(also_brocoind=also_brocoind)
        self.running = False
    ...
    def restart(self) -> None:
        ...
        self.stop(also_brocoind=False)
        # Make a clean start
        super().restart()
        self.brocoind.restart()
        self.start(also_brocoind=False)
